...
def ParseOptionalForRemainder(parser):
  """Alternate ._parse_optional method for an argparse.Parser.
  ...
  def ParseOptional(arg_string):
    positional_actions = parser._get_positional_actions()
    option_tuple = parse_optional(arg_string)
