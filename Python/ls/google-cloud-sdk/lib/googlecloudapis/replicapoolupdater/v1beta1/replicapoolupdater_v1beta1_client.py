...
class ReplicapoolupdaterV1beta1(base_api.BaseApiClient):
  ...
  class UpdatesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      ...
      self._method_configs = {
          'Cancel': base_api.ApiMethodInfo(
              ...
              ordered_params=[u'project', u'zone', u'instanceGroupManager', u'update'],
              path_params=[u'instanceGroupManager', u'project', u'update', u'zone'],
              query_params=[],
              relative_path=u'projects/{project}/zones/{zone}/instanceGroupManagers/{instanceGroupManager}/updates/{update}/cancel',
              request_field='',
          ...
          'Get': base_api.ApiMethodInfo(
              ...
              path_params=[u'instanceGroupManager', u'project', u'update', u'zone'],
              query_params=[],
              relative_path=u'projects/{project}/zones/{zone}/instanceGroupManagers/{instanceGroupManager}/updates/{update}',
              request_field='',
          ...
          'ListInstanceUpdates': base_api.ApiMethodInfo(
              http_method=u'GET',
              method_id=u'replicapoolupdater.updates.listInstanceUpdates',
              ordered_params=[u'project', u'zone', u'instanceGroupManager', u'update'],
              path_params=[u'instanceGroupManager', u'project', u'update', u'zone'],
              query_params=[u'maxResults', u'pageToken'],
              relative_path=u'projects/{project}/zones/{zone}/instanceGroupManagers/{instanceGroupManager}/updates/{update}/instanceUpdates',
              request_field='',
              request_type_name=u'ReplicapoolupdaterUpdatesListInstanceUpdatesRequest',
          ...
          'Pause': base_api.ApiMethodInfo(
              ...
              path_params=[u'instanceGroupManager', u'project', u'update', u'zone'],
              query_params=[],
              relative_path=u'projects/{project}/zones/{zone}/instanceGroupManagers/{instanceGroupManager}/updates/{update}/pause',
              request_field='',
          ...
          'Rollback': base_api.ApiMethodInfo(
              ...
              path_params=[u'instanceGroupManager', u'project', u'update', u'zone'],
              query_params=[],
              relative_path=u'projects/{project}/zones/{zone}/instanceGroupManagers/{instanceGroupManager}/updates/{update}/rollback',
              request_field='',
          ...
          'Rollforward': base_api.ApiMethodInfo(
              ...
              path_params=[u'instanceGroupManager', u'project', u'update', u'zone'],
              query_params=[],
              relative_path=u'projects/{project}/zones/{zone}/instanceGroupManagers/{instanceGroupManager}/updates/{update}/rollforward',
              request_field='',
    ...
    def ListInstanceUpdates(self, request, global_params=None):
      """Lists instance updates for a given update.

      Args:
        request: (ReplicapoolupdaterUpdatesListInstanceUpdatesRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
    ...
    def Pause(self, request, global_params=None):
      """Called on the particular Update endpoint. Pauses the update in state ROLLING_FORWARD or ROLLING_BACK. No-op if invoked in state PAUSED.
    ...
    def Rollback(self, request, global_params=None):
      """Called on the particular Update endpoint. Rolls back the update in state ROLLING_FORWARD or PAUSED. No-op if invoked in state ROLLED_BACK or ROLLING_BACK.
    ...
    def Rollforward(self, request, global_params=None):
      """Called on the particular Update endpoint. Rolls forward the update in state ROLLING_BACK or PAUSED. No-op if invoked in state ROLLED_OUT or ROLLING_FORWARD.
